...
from webArt.sitemaps import StaticViewSitemap
from Artist.sitemaps import ArtistSitemap
from Artwork.sitemaps import ArtworkSitemap
...
if settings.MAINTENANCE_MODE:
    urlpatterns.insert(
        0,
        re_path(
            r"^", TemplateView.as_view(template_name="503.html"), name="maintenance"
        ),
    )
